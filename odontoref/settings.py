# Django settings for odontoref project.
import commands
import os
import sys
...
SECRET_KEY = 'o0+7)1$#x9kr&t%3knnb+8=-2x#y!8*2o$+m#*b263o(m83=mx'
...
ROOT_URLCONF = 'odontoref.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'odontoref.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('odontoref.migrations', 'odontoref.tests',
                            'odontoref.local_settings',
